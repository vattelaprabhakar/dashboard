...
namespace FortuneTechPvtLtd.Controllers
{
    public class SmsAlertsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            try
            {
                var alertobj = entity.tbl_alerts.Where(m => m.compId == CurrentCompanyId && m.brId == CurrentCompanyBranchId && m.alert_type.ToUpper() == "SMS".ToUpper()).ToList().OrderByDescending(m=>m.alert_Id);
        ...
        public ActionResult AddSmsAlerts()
        {
            Props();
            EmailAlertsModel r = new EmailAlertsModel();
            return View(r);
        ...
        [HttpPost]
        public ActionResult AddSmsAlerts(EmailAlertsModel data, FormCollection formdata)
        {
        ...
        private void Props()
        {
            ...
            var alertmaster = entity.tbl_alerts_master.Where(m => m.alert_master_type == "SMS").ToList();
